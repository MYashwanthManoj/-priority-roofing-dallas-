...
export default function InspectionForm() {
  ...
  return (
    <Reveal as="div" className="inspection-form">
      {status === 'success' ? (
        <div className="form-success form-success-full show" role="status">
          ...
          <p className="form-success-sub">Need us right away? Call <a href={business.phoneHref}>{business.phone}</a></p>
        </div>
      ) : (
